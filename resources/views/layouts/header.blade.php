<nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background-color: #7b68ee;" >
    <div class="container">
        ...
        <div class="collapse navbar-collapse dropdown" id="navbarSupportedContent" >
            <!-- Left Side Of Navbar -->
                ...
                <ul class="nav navbar-nav dropdown show" >
                        @include('layouts.top_menu', ['categories'=>$categoriess])
                </ul>
